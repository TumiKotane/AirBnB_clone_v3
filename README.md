...
Group project done by : Olebogeng Morobe asnd Boitumelo Kotane

1. Introduction
Team project to build a clone for AirBnB
...
Version 2 MySQL using Python, OOP, Backend, SQL, ORM and SQLAlchemy
